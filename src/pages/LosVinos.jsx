    ...
    <div id="scroll-animate-main" className="LosVinos">
      <div className="wrapper-parallax">
        <div
          ...
          style={{
            backgroundImage: `url(${"/Images/losvinos/FincaPropiaMar20-484-scaled.jpg"})`,
          }}
        >
          <h1>Los vinos</h1>
        </div>
          ...
          <div className="datos">
            <section className="vinos">
              <article className="signature">
                  ...
                  al como lo hizo con aquel Syrah de Finca La Anita, Antonio Mas
                  continúa sorprendiéndonos con un estilo de vinos que,
